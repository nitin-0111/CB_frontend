...
//       const userHandles = [...handles];
//       // console.log(userHandles);
//       const response = await axios.post("/api/v1/vcontest/publishContest", {
//         userHandles,
//         RoomId,
//       });
//       navigate(`/ContestArea/${RoomId}/${handle}`);
...
//     }
//     checkhandle(instance);
//     async function checkhandle(instance) {
//       let fl = 1;
//       for (let i = 0; i < instance.length; i++) {
//         // console.log(instance[i].tag);
//         const CodeforceURL = "https://codeforces.com/api/user.info?handles=";
...
//         <div>
//           <h4>Added Handles</h4>
//           {/* <ul className="listItemsHandles"></ul> */}
//           <ul> {handleList}</ul>
//         </div>
//       </div>

//       {/* button to pulish contest  */}
//       <button onClick={handlePublish}> publish</button>
//     </div>
//   );
// };
